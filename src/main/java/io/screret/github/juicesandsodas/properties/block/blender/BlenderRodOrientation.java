...
public enum BlenderRodOrientation implements IStringSerializable {
    ...
    private BlenderRodOrientation(String name, boolean input, boolean output, BlockPos toCenter) {
        this.name = name;
