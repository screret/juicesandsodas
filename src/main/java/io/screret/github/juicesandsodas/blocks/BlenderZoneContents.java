...
public class BlenderZoneContents implements IInventory {

    /**
     * Use this constructor to create a BlenderZoneContents which is linked to its parent TileEntity.
     ...
     */
    public static BlenderZoneContents createForTileEntity(int size,
                                                          Predicate<PlayerEntity> canPlayerAccessInventoryLambda,
                                                          Notify markDirtyNotificationLambda) {
        return new BlenderZoneContents(size, canPlayerAccessInventoryLambda, markDirtyNotificationLambda);
    }

    /**
     * Use this constructor to create a BlenderZoneContents which is not linked to any parent TileEntity; i.e.
    ...
    private BlenderZoneContents(int size) {
        this.furnaceComponentContents = new ItemStackHandler(size);
    }

    private BlenderZoneContents(int size, Predicate<PlayerEntity> canPlayerAccessInventoryLambda, Notify markDirtyNotificationLambda) {
        this.furnaceComponentContents = new ItemStackHandler(size);
        this.canPlayerAccessInventoryLambda = canPlayerAccessInventoryLambda;
        this.markDirtyNotificationLambda = markDirtyNotificationLambda;
    }
